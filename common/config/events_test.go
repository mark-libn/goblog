...
func TestHandleRefreshEvent(t *testing.T) {
        ...
        Convey("Given a refresh event received, targeting our application", t, func() {
                var body = `{"type":"RefreshRemoteApplicationEvent","timestamp":1494514362123,"originService":"config-server:docker:8889","destinationService":"accountservice:**","id":"53e61c71-cbae-4b6d-84bb-d0dcc0aeb4dc"}
`
...
func TestHandleRefreshEventForOtherApplication(t *testing.T) {
        ...
        Convey("Given a refresh event received, targeting another application", t, func() {
                var body = `{"type":"RefreshRemoteApplicationEvent","timestamp":1494514362123,"originService":"config-server:docker:8889","destinationService":"vipservice:**","id":"53e61c71-cbae-4b6d-84bb-d0dcc0aeb4dc"}
`
